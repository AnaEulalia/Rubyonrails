...
class MensagensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensagem" do
    assert_difference("Mensagem.count") do
      post mensagens_url, params: { mensagem: { conteudo: @mensagem.conteudo, titulo: @mensagem.titulo } }
    end
  ...
  test "should update mensagem" do
    patch mensagem_url(@mensagem), params: { mensagem: { conteudo: @mensagem.conteudo, titulo: @mensagem.titulo } }
